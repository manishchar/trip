...
<!---->
  <div class="grid-form1">
  	       <h3>Update trip</h3>
                ...
                <div class="text-center" style="color: green"><?php echo  $this->session->flashdata('s') ;?></div>   
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<?php echo form_open_multipart('Admin_Controller/trip_update_save');?>
							<?php foreach($trip as $row) { ?>
							<label for="id" ><b>Trip Id</b></label>
                       <!-- <div style="color: red;"><?php //echo form_error('name'); ?></div>
                         --> 
                      <input type="text" name="id" value="<?php echo $row->id?>"  placeholder="Trip id" class="form-control" readonly="readonly">
                      ...
                      <label for="file"><b>Feature Image</b></label>
                       <input  name="trip_file" value="<?php echo $row->image ; ?> "   class="form-control" type="file" >
                     ...
                     <label for="hotel_price" "><b>Hotel room with price</b></label>
                      ...
                      <input type="text" name="picup_price" value="<?php echo $row->picup_price ; ?> " pickup price" class="form-control " >
