...
<!--header end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo site_url('admin_controller/index') ;?>">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
...
<!-- Bootstrap Core JavaScript -->
   ...
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src="<?php echo base_url()?>assets/admin/js/admin/raphael-min.js"></script>
